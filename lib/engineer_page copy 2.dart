...
class _EngineerPageState extends State<EngineerPage> {
  ...
  Future<void> fetchAllRowCounts() async {
    ...
    int fetchedRowCountCB = await apiServiceCB.fetchCycleBRowCount();
    int fetchedRowCountCC = await apiServiceCC.fetchCycleCRowCount();
    int fetchedRowCountDA = await apiServiceDA.fetchCycleARowCount();
    int fetchedRowCountDB = await apiServiceDB.fetchCycleBRowCount();
    int fetchedRowCountDC = await apiServiceDC.fetchCycleCRowCount();
    int fetchedRowCountHA = await apiServiceHA.fetchCycleARowCount();
    int fetchedRowCountHB = await apiServiceHB.fetchCycleBRowCount();
    int fetchedRowCountHC = await apiServiceHC.fetchCycleCRowCount();
