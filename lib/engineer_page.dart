...
class _EngineerPageState extends State<EngineerPage> {
  ...
  int rowCountHA = 0, rowCountHB = 0, rowCountHC = 0;
  int rowCountDA = 0, rowCountDB = 0, rowCountDC = 0;
  int rowCountCA = 0, rowCountCB = 0, rowCountCC = 0;
  ...
  Future<void> fetchAllRowCounts() async {
    // Example API services for each type
    final apiServiceCA = APIServiceCA();
    final apiServiceCB = APIServiceCB();
    final apiServiceCC = APIServiceCC();
    final apiServiceDA = APIServiceDA();
    final apiServiceDB = APIServiceDB();
    final apiServiceDC = APIServiceDC();
    final apiServiceHA = APIServiceHA();
    final apiServiceHB = APIServiceHB();
    final apiServiceHC = APIServiceHC();

    // Fetch the data asynchronously
    int fetchedRowCountCA = await apiServiceCA.fetchCycleARowCount();
    int fetchedRowCountCB = await apiServiceCB.fetchCycleARowCount();
    int fetchedRowCountCC = await apiServiceCC.fetchCycleARowCount();
    int fetchedRowCountDA = await apiServiceDA.fetchCycleARowCount();
    int fetchedRowCountDB = await apiServiceDB.fetchCycleARowCount();
    int fetchedRowCountDC = await apiServiceDC.fetchCycleARowCount();
    int fetchedRowCountHA = await apiServiceHA.fetchCycleARowCount();
    int fetchedRowCountHB = await apiServiceHB.fetchCycleARowCount();
    int fetchedRowCountHC = await apiServiceHC.fetchCycleARowCount();

    // Update state with the fetched data
    setState(() {
      rowCountCA = fetchedRowCountCA;
      rowCountCB = fetchedRowCountCB;
      rowCountCC = fetchedRowCountCC;
      rowCountDA = fetchedRowCountDA;
      rowCountDB = fetchedRowCountDB;
      rowCountDC = fetchedRowCountDC;
      rowCountHA = fetchedRowCountHA;
      rowCountHB = fetchedRowCountHB;
      rowCountHC = fetchedRowCountHC;
      
      // Recalculate totals
      totalCycles = rowCountCA + rowCountCB + rowCountCC;
      totalHours = rowCountHA + rowCountHB + rowCountHC;
      totalDate = rowCountDA + rowCountDB + rowCountDC;
      total = totalCycles+totalDate+totalHours;
    });
  }
